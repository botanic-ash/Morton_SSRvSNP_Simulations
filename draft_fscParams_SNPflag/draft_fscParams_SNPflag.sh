...
dir=/home/akoontz/Documents/SSRvSNP/Simulations/Code/draft_fscParams_SNPflag
...
# -s is for DNA markers, and tells fastSimcoal2 to specify the marker data as SNPs
...
# 16 populations
fsc2702 -i $dir/params_DNA/DNA_16pops_migHigh.par -n $reps -g -p -s
fsc2702 -i $dir/params_DNA/DNA_16pops_migLow.par -n $reps -g -p -s
