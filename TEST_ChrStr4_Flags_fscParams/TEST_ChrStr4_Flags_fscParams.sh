...
dir=/home/akoontz/Documents/SSRvSNP/Simulations/Code/TEST_ChrStr4_Flags_fscParams
...
# ---RADseq simulations---
# 1 population
fsc2702 -i $dir/params_DNA/DNA_01pops_migHigh.par -n $reps -g -S -G
fsc2702 -i $dir/params_DNA/DNA_01pops_migLow.par -n $reps -g -S -G
# 4 populations
fsc2702 -i $dir/params_DNA/DNA_04pops_migHigh.par -n $reps -g -S -G
fsc2702 -i $dir/params_DNA/DNA_04pops_migLow.par -n $reps -g -S -G
# 16 populations
fsc2702 -i $dir/params_DNA/DNA_16pops_migHigh.par -n $reps -g -S -G
fsc2702 -i $dir/params_DNA/DNA_16pops_migLow.par -n $reps -g -S -G
