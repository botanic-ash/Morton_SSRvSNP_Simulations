...
# This directory refers to parameter files that specify DNA markers with 200 bp in length (last line, "number of loci"), as well as a mutation rate of 1e-6
dir=/home/akoontz/Documents/SSRvSNP/Simulations/Code/draft_fscParams_DNA300_lowMutation
