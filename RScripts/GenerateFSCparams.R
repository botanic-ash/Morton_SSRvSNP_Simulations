...
# Convert Arlequin outputs to genind
print("%%% Convert Arlequin outputs to genind")
DNA_highMut_01pop_migLow.genind <- convertAllArp(arp.path = paste0(dna.wd, "DNA_highMut_01pop_migLow/"), 
                                         params = DNA_highMut_01pop_migLow.params)
DNA_highMut_01pop_migHigh.genind <- convertAllArp(arp.path = paste0(dna.wd, "DNA_highMut_01pop_migHigh/"), 
...
# Convert Arlequin outputs to genind
print("%%% Convert Arlequin outputs to genind")
DNA_highMut_04pop_migLow.genind <- convertAllArp(arp.path = paste0(dna.wd, "DNA_highMut_04pop_migLow/"), 
                                         params = DNA_highMut_04pop_migLow.params)
DNA_highMut_04pop_migHigh.genind <- convertAllArp(arp.path = paste0(dna.wd, "DNA_highMut_04pop_migHigh/"), 
...
# Convert Arlequin outputs to genind
print("%%% Convert Arlequin outputs to genind")
DNA_highMut_16pop_migLow.genind <- convertAllArp(arp.path = paste0(dna.wd, "DNA_highMut_16pop_migLow/"), 
                                         params = DNA_highMut_16pop_migLow.params)
DNA_highMut_16pop_migHigh.genind <- convertAllArp(arp.path = paste0(dna.wd, "DNA_highMut_16pop_migHigh/"), 
