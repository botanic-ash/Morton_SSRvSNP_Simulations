...
# This script is run from the output directory (on the server /RAID1 drive)

# Specify input directory, which contains relevant fasSimcoal2 parameter files
# This directory refers to parameter files that specify DNA markers with 200 bp in length (last line, "number of loci"), as well as a mutation rate of 1e-4
dir=/home/akoontz/Documents/SSRvSNP/Simulations/Code/draft_fscParams_DNA300_medMutation
